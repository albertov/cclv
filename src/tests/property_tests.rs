...
//
// NOTE: Property tests for ScrollState.vertical_offset have been deleted.
// Scroll position is now managed by ConversationViewState via ScrollPosition.
// The vertical_offset field is maintained via dual-write for view layer compatibility.
// See cclv-5ur.6.4 for migration details and scroll_handler_migration_tests.rs for
// verification that scroll_handler uses ScrollPosition correctly.
